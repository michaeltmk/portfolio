...
import { usePersonalInfo, useAssets } from '@/lib/portfolio-context';

export function Presentation() {
  // Load personal information from context
  ...
  const profile = {
    ...
    src: assets.profile_images.main,
    fallbackSrc: assets.profile_images.fallback,
  };
