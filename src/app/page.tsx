...
import { usePersonalInfo, useRepositoryInfo, useAssets } from '@/lib/portfolio-context';
...
export default function Home() {
  ...
  const repository = useRepositoryInfo();
  ...
  useEffect(() => {
    ...
    img.src = assets.profile_images.avatar;
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-4 pb-10 md:pb-20">
      ...
      <div className="absolute top-6 left-6 z-20">
        <button
          onClick={() => goToChat('Are you looking for an opportunity?')}
      ...
      {/* centre memoji */}
      <div className="relative z-10 h-48 w-44 overflow-hidden sm:h-64 sm:w-64">
        <Image
          src={assets.profile_images.avatar}
          alt="Hero avatar"
          width={2000}
          height={2000}
          priority
